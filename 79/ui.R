...
shinyUI(fluidPage(
  ...
  sidebarPanel(id = "personal",
               p("此在线App提取2017年6月4日12点前英雄榜所有75-79级70000装评以上冰心的数据，如果您的号符合上述条件但是
               ...
               selectInput("distribution","分布概览，请选择", choices = c("服务器","名字用字","势力","翅膀","耳环一",
                                                                  ...
                                                                  "手镯二","武器","副手","头冠","肩膀","衣服",
                                                                  "护腕","腰带","下摆","裤子","鞋")),
               selectInput("sort","属性排序,显示前50名,请选择属性名称,再点击排序按钮并在右侧列表中查看",choices = c("装评","敏","力","魂","念","疾","体",
                                                            "最小物攻","最大物攻","最小法攻","最大法攻","命中",
                                                            "会心","重击","诛心","御心","万钧","铁壁","人祸",
                                                            "疾语","追电","物防","法防","生命值","技力值","神明",
                                                            "回避","知彼")),
               textInput("similarity","相似度,请输入您的英雄榜，并在右侧列表中查看与您属性最相近和最相反的各10名玩家",
                         "")
